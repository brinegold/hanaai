      ...
      <div className="max-w-md mx-auto pt-10 px-4 pb-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-white text-3xl font-bold mb-2">
            {mode === "login" ? "Welcome Back" : "Join Hana"}
          </h1>
        ...
        <div className="flex justify-center space-x-4 mt-8">
          <a href="https://t.me/Hanadex" className="social-link social-telegram">
          ...
          <a href="https://x.com/HanaCoin" className="social-link social-twitter">
            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="mailto:support@nebrix.dev " className="social-link social-email">
            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
